...
data = dict(
    ...
    train_dataloader=dict(
        samples_per_gpu=32, drop_last=True, persistent_workers=False),
...
checkpoint_config = dict(interval=1250, save_optimizer=True, by_epoch=False)
evaluation = dict(interval=1250, save_image=False)
log_config = dict(
    interval=100,
    hooks=[
