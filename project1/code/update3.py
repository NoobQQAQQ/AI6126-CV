...
runner = dict(type='EpochBasedRunner', max_epochs=60) #按epoch的方式进行迭代
checkpoint_config = dict(by_epoch=True, interval=60) #每多少epoch保存一次模型
evaluation = dict(interval=5, metric='mIoU', pre_eval=True)  # 每多少epoch计算一次指标
